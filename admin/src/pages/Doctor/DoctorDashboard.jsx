                                ...
                                </div>
                                {
                                    item.cancelled ? (
                                        ...
                                        <div className='flex gap-2'>
                                            <img
                                                onClick={async () => {
                                                    await cancelAppointment(item._id);       // gọi API huỷ
                                                    await getDashboardData();                // cập nhật lại dữ liệu để giao diện thay đổi
                                                }}
                                            ...
                                            <img
                                                onClick={async () => {
                                                    await completeAppointment(item._id);     // gọi API hoàn thành
                                                    await getDashboardData();                // cập nhật lại dữ liệu để giao diện thay đổi
                                                }}
                                                className='w-10 cursor-pointer hover:scale-105 transition'
